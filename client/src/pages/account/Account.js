  ...
  useEffect(() => {
    ...
    .then(currentTokken=>{
        ...
        .then((snap)=>{
            ...
            setCampaignParticipation(tempCampaignsParticipated);
            }
        ).catch((err)=>{
                    ...
                    <div style={{margin:'10%'}}>
                      <div className='row'>
                        <div className='card column'>
                          ...
                          <div className='card-body'>
                            <h2><span style={{fontSize:'20px'}}>Rs</span>{totalDonationAmount}<span style={{fontSize:'20px'}}>/-</span></h2>
                          </div>
                        </div>
                        <div className='card column'>
                          <div className='card-header'>Number of Donations</div>
                          <div className='card-body'>
                            <h2>{campaignParticipation} <span style={{fontSize:'20px'}}></span></h2>
                          </div>
                        </div>
                      </div>
                      <div className="mt-3">
                      ...
                      <br/> */}
                      { showLoader && <div style={{ marginLeft:'45%'}}>
                          <PuffLoader size={100}/>
                      </div>}
